package com.example.froze.customize_component;
...
/**
 * Created by froze on 2016-10-20.
 */
...
public class Today extends TextView{
    ...
    public Today(Context context, AttributeSet attrs){
        ...
        // 반복문을 돌면서 해당 attr에 입력된 값을 저리해 준다
    ...
    public Today(Context context, AttributeSet attrs, int defSyleAttr){
